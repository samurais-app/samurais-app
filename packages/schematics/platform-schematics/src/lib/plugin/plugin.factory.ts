...
function transform(options: PluginOptions): PluginOptions {
  const target: PluginOptions = Object.assign({}, options);
...
function generate(options: PluginOptions, path: string): Source {
